...
<?php include('menu.php')?>
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
			<a href="store.php" class="stext-109 cl8 hov-cl1 trans-04">
				Store
						...
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="">
								<div class="item-slick3">
									...
									<img src="../images/products/<?php echo htmlentities($product['product_image']);?>"class="card-img-top" alt="...">
						...
						<input type="hidden" name="product_id" value= <?php echo $product['product_id'] ?>>	
							<div class="flex-w p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<input class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail" name = "addToCart" type = "submit"  value = "Add To cart">
