...
if (check_permission() != 1) {
    ...
    echo ("<script>alert('You're not an admin. Redirecting to Store.'); window.location.href = '../views/store.php';</script>");
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Add Brand</a></li>
                    </ol>
                </div>
            </div>
            <!-- Add brand form -->
