                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            <?php
                                            //call the selelect all products controller
                                            ...
                                            foreach($products as $product){
                                                echo 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href='../admin/updateproduct.php?product_id={$product['product_id']}'>Update</a></td>
                                                        <td><a href='../actions/delete_product.php?product_id={$product['product_id']}'>Delete</a></td>
                                                    </tr>
                                                    ";
                                                }
